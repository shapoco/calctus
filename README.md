...
|[Cast](./FUNCTIONS.md#cast)|[array(x)](./FUNCTIONS.md#arrayx), [real(*x)](./FUNCTIONS.md#realx), [str(x)](./FUNCTIONS.md#strx)|
...
|[Rational](./FUNCTIONS.md#rational)|[rat(*x)](./FUNCTIONS.md#ratx), [rat(*x, max)](./FUNCTIONS.md#ratx-max)|
...
|[System](./FUNCTIONS.md#system)|[assert(x)](./FUNCTIONS.md#assertx), [isDebugBuild()](./FUNCTIONS.md#isdebugbuild), [version()](./FUNCTIONS.md#version)|
