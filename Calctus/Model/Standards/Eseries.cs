...
namespace Shapoco.Calctus.Model.Standards {
    ...
    static class ESeries {
        ...
        public static real[] E96 = new real[] {
        ...
        public static real[] E192 = new real[] {
