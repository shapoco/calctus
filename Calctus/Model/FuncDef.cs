...
namespace Shapoco.Calctus.Model {
    class FuncDef {
        ...
        public static readonly FuncDef clog2 = new FuncDef("clog2", (e, a) => new RealVal(Math.Ceiling(Math.Log(a[0].AsDouble) / Math.Log(2.0))));
        ...
        public static readonly FuncDef floor = new FuncDef("floor", (e, a) => new RealVal(Math.Floor(a[0].AsDouble), a[0].FormatHint, a[0].Unit));
        public static readonly FuncDef ceil = new FuncDef("ceil", (e, a) => new RealVal(Math.Ceiling(a[0].AsDouble), a[0].FormatHint, a[0].Unit));
        public static readonly FuncDef trunc = new FuncDef("trunc", (e, a) => new RealVal(Math.Truncate(a[0].AsDouble), a[0].FormatHint, a[0].Unit));
        public static readonly FuncDef round = new FuncDef("round", (e, a) => new RealVal(Math.Round(a[0].AsDouble), a[0].FormatHint, a[0].Unit));
        public static readonly FuncDef sign = new FuncDef("sign", (e, a) => new RealVal(Math.Sign(a[0].AsDouble)));
