...
namespace Shapoco.Calctus.Model.Functions.BuiltIns {
    class ESeriesFuncs : BuiltInFuncCategory {
        ...
        public readonly BuiltInFuncDef esFloor = new BuiltInFuncDef("esFloor(series, *x@)",
            ...
            (e, a) => PreferredNumbers.Floor(ESeries.GetSeries(a[0].AsInt), a[1].AsDecimal).ToRealVal());
        ...
        public readonly BuiltInFuncDef esCeil = new BuiltInFuncDef("esCeil(series, *x@)",
            ...
            (e, a) => PreferredNumbers.Ceiling(ESeries.GetSeries(a[0].AsInt), a[1].AsDecimal).ToRealVal());
        ...
        public readonly BuiltInFuncDef esRound = new BuiltInFuncDef("esRound(series, *x@)",
            ...
            (e, a) => PreferredNumbers.Round(ESeries.GetSeries(a[0].AsInt), a[1].AsDecimal).ToRealVal());
        ...
        public readonly BuiltInFuncDef esRatio = new BuiltInFuncDef("esRatio(series, *x)",
            ...
            (e, a) => PreferredNumbers.FindSplitPair(ESeries.GetSeries(a[0].AsInt), a[1].AsDecimal).ToArrayVal(a[1].FormatHint, null));
    }
}
