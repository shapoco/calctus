...
namespace Shapoco.Calctus.Model.Types {
    static class ValExtensions {
        public static RealVal ToRealVal(this decimal val, FormatHint fh = null) => new RealVal(val, fh);
        ...
        public static RealVal ToIntVal(this decimal val) => new RealVal(val, FormatHint.CStyleInt);
        ...
        public static RealVal ToHexVal(this decimal val) => new RealVal(val, FormatHint.CStyleHex);
        ...
        public static RealVal ToCharVal(this decimal val) => new RealVal(val, FormatHint.CStyleChar);
        ...
        public static RealVal ToRelativeTimeVal(this decimal val) => new RealVal(val, FormatHint.RelativeTime);
        ...
        public static Val[] ToValArray(this decimal[] val, FormatHint fh = null) {
        ...
        public static ArrayVal ToArrayVal(this decimal[] val, FormatHint elemFmt, FormatHint arrayFmt)=> new ArrayVal(val.ToValArray(elemFmt), arrayFmt);
        ...
        public static ArrayVal ToArrayVal(this decimal[] val) => new ArrayVal(val.ToValArray());
        ...
        public static decimal[] ToRealArray(this Val[] val) {
